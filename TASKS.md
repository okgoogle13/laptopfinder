...
- `[x]` `[IDE/DEV]` Wrap Gemini API calls in `src/laptopfinder/runners/comet.py` and `aistudio.py` in try/except with exponential backoff retries. *(obsolete: runners deleted in #13, retries added to enrichment in #18)*
