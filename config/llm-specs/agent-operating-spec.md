...
**Scope:** how agents think, code, and handle evidence — and how they talk to me. Voice for messages I send as myself lives in `voice-profile.md`. Deployment lives in `wiring.md`. Load all three.
