...
|---|---|---|---|---|
| GPU reference | [config/static_reference_layer.json](../../config/static_reference_layer.json) | [prompts/search_queries.txt](../../prompts/search_queries.txt) | High | Owns target GPU lists, watch list, generation hints, and pricing bands. |
...
| Search heuristics | [prompts/search_queries.txt](../../prompts/search_queries.txt) | [prompts/comet_discovery_agent.txt](../../prompts/comet_discovery_agent.txt) (legacy reference) | High | Boolean discovery seed queries for eBay AU, Gumtree, and FB Marketplace. Edit here; legacy comet prompt refers to this file for VRAM verification heuristics. |
