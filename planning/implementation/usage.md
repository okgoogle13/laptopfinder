# Usage Guide — Sprint 2 Components

Built by /deep-implement from `planning/sections/`. Covers `inject_config.py`, `scrape_live.py`, `render_matrix.py`, and their Makefile targets.
